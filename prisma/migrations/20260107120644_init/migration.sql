...
-- CreateEnum
CREATE TYPE "StockLevel" AS ENUM ('IN_STOCK', 'LOW_STOCK', 'OUT_OF_STOCK', 'DISCONTINUED');
...
CREATE TABLE "Product" (
    ...
    "stockLevel" "StockLevel" NOT NULL,
...
-- CreateIndex
CREATE INDEX "Product_slug_isActive_categoryId_idx" ON "Product"("slug", "isActive", "categoryId");
...
-- CreateIndex
CREATE INDEX "Order_orderNumber_status_userId_createdAt_idx" ON "Order"("orderNumber", "status", "userId", "createdAt");
